classdef AgentForArrive < Object
    ...
    methods
        ...
        function steering = steeringSeek(obj, target) 
           ...
           target_offset = target-obj.position;
           distance =length(target_offset);
           ramped_speed = obj.max_speed*(distance/10);
           clipped_speed = min(ramped_speed,obj.max_speed);
